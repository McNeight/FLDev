...
Fl_Double_Window* make_proj_wizard() {
  { proj_wiz = new Fl_Double_Window(498, 314, "New Project");
    { pr_dir_input = new Fl_Input(130, 65, 320, 25, "Project Directory");
    } // Fl_Input* pr_dir_input
    { pr_wiz_browse_btn = new Fl_Button(455, 65, 35, 25, "...");
    ...
    { pr_wiz_ok_btn = new Fl_Button(320, 270, 80, 25, "OK");
      pr_wiz_ok_btn->callback((Fl_Callback*)cb_pr_wiz_ok_btn);
    } // Fl_Button* pr_wiz_ok_btn
    { pr_wiz_cancel_btn = new Fl_Button(410, 270, 80, 25, "Cancel");
    ...
    { main_cpp_chk = new Fl_Check_Button(130, 235, 155, 25, "Generate \'main.cpp\'");

...
Fl_Double_Window* make_pref_form() {
  ...
  { Fl_Double_Window* o = pref_window = new Fl_Double_Window(525, 330, "Preferences");
    ...
    { Fl_Tabs* o = pref_tabs = new Fl_Tabs(5, 5, 515, 285);
      { Fl_Group* o = ed_group = new Fl_Group(10, 40, 510, 250, "Editor");
        ...
        { Fl_Box* o = pref_highlight_label = new Fl_Box(290, 40, 220, 235, "Highlight Colors");
          o->box(FL_ENGRAVED_BOX);
          o->labeltype(FL_ENGRAVED_LABEL);
          o->align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE);
        }
        ...
        { Fl_Button* o = type_btn = new Fl_Button(320, 170, 15, 15, "Types");
          o->callback((Fl_Callback*)cb_type_btn);
          o->align(FL_ALIGN_RIGHT);
        }
        { Fl_Button* o = keyword_btn = new Fl_Button(320, 190, 15, 15, "Keywords");

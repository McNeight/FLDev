...
/**
  ...
  \see item_first(), item_last(), item_next(), item_prev()
*/
void* NavBrowser::item_next(void* item) const {return ((FL_BLINE*)item)->next;}
...
/**
  ...
  \see item_first(), item_last(), item_next(), item_prev()
*/
void* NavBrowser::item_prev(void* item) const {return ((FL_BLINE*)item)->prev;}
...
/**
  ...
  \see item_first(), item_last(), item_next(), item_prev()
*/
void* NavBrowser::item_last() const {return last;}
...
*/
int NavBrowser::item_selected(void* item) const {
...
/**
  ...
  \see select(), selected(), value(), item_select(), item_selected()
*/
void NavBrowser::item_select(void *item, int val) {
...
*/
const char *NavBrowser::item_text(void *item) const {
...
/**
  ...
  \see item_at(), find_line(), lineno()
*/
int NavBrowser::lineno(void *item) const {
...
*/
void NavBrowser::insert(int line, FL_BLINE* item) {
  if (!first) {
...
*/
int NavBrowser::item_height(void *item) const {
  FL_BLINE* l = (FL_BLINE*)item;
...
/**
  ...
  \see item_height(), item_width(),\n
       incr_height(), full_height()
*/
int NavBrowser::item_width(void *item) const {
  FL_BLINE* l=(FL_BLINE*)item;
  char* str = l->txt;
  const int* i = column_widths();
  int ww = 0;
...
*/
void NavBrowser::item_draw(void* item, int X, int Y, int W, int H) const {
  FL_BLINE* l = (FL_BLINE*)item;
  char* str = l->txt;
  const int* i = column_widths();
  int maxsub = 0;
...
/**
  ...
  \see select(), selected(), value(), item_select(), item_selected()
*/
int NavBrowser::select(int line, int val) {
  if (line < 1 || line > lines) return 0;
...
/**
  ...
  \see show(int), hide(int), display(), visible(), make_visible()
*/
void NavBrowser::display(int line, int val) {
  if (line < 1 || line > lines) return;
...
*/
void NavBrowser::swap(FL_BLINE *a, FL_BLINE *b) {
...
/**
  ...
  \see swap(int,int), item_swap()
*/
void NavBrowser::swap(int a, int b) {
...
*/
void NavBrowser::icon(int line, Fl_Image* icon) {
...
*/
Fl_Image* NavBrowser::icon(int line) const {
...
*/
void NavBrowser::remove_icon(int line) { 
  icon(line,0);
}

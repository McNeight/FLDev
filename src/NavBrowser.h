//
// "$Id: NavBrowser.H,v 1.8.2.7.2.5 2003/06/15 04:47:27 easysw Exp $"
//
...
class NavBrowser : public Fl_Browser_ {
...
public:
  ...
  void draw() {clearsubs(); Fl_Browser_::draw();}
  ...
  NavBrowser(int, int, int, int, const char* = 0);
  ~NavBrowser() { clear(); }
...
//
// End of "$Id: NavBrowser.H,v 1.8.2.7.2.5 2003/06/15 04:47:27 easysw Exp $".
//
